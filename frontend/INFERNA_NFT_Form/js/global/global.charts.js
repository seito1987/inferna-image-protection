...
app.querySelector('#profile-completion-chart', function (el) {
  ...
  gradient.addColorStop(0, '#149414');
  gradient.addColorStop(1, '#149414');
...
app.querySelector('#posts-engagement-chart', function (el) {
  ...
  gradient.addColorStop(0, '#149414');
  gradient.addColorStop(1, '#FFF04B');
          ...
          datasets: [
            {
              ...
              pointBorderColor: "#F94909",
              pointBackgroundColor: "#fff",
              pointBorderWidth: 4,
              pointHoverRadius: 5,
              pointHoverBackgroundColor: "#fff",
              pointHoverBorderColor: "#F94909",
          ...
          datasets: [
            {
              ...
              pointBackgroundColor: "#F94909",
              pointBorderWidth: 2,
              pointHoverRadius: 4,
              pointHoverBorderColor: "#fff",
              pointHoverBackgroundColor: "#F94909",
